...
func TestAnalyzePath(t *testing.T) {
	...
	ui := CreateExportUI(output, reportOutput, false, false, false, false, false)
...
func TestAnalyzePathWithProgress(t *testing.T) {
	...
	ui := CreateExportUI(output, reportOutput, true, true, true, true, false)
	ui.SetIgnoreDirPaths([]string{"/xxx"})
	err := ui.AnalyzePath("test_dir", nil)
	assert.Nil(t, err)
	err = ui.StartUILoop()
...
func TestShowDevices(t *testing.T) {
	...
	ui := CreateExportUI(output, reportOutput, false, true, false, false, false)
...
func TestFormatSizeDec(t *testing.T) {
	...
	ui := CreateExportUI(output, reportOutput, false, true, false, true, false)
